 ...
 */
export async function handleButtonInteraction(interaction: ButtonInteraction<CacheType>): Promise<void> {
 ...
 */
async function handleButtonInteractionInternal(interaction: ButtonInteraction<CacheType>): Promise<void> {
    ...
    try {
        ...
        } else if (customId === 'schedule_add_new' || customId === 'budget_add_new' ||
