...
export function createTaskEmbed(title: string, fields?: Array<{ name: string; value: string; inline?: boolean }>): EmbedBuilder {
...
export function createListEmbed(title: string, listName: string, items: Array<{ text: string; completed: boolean }>): EmbedBuilder {
...
export function createRandomEmbed(title: string, description: string, footer?: string): EmbedBuilder {
    const embed = new EmbedBuilder()
