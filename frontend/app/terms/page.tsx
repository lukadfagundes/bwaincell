        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              Welcome to Bwain.app! These Terms of Service ("Terms") govern your
              access to and use of Bwain.app's website, Progressive Web
              Application (PWA), and related services (collectively, the
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-foreground space-y-2">
              <li>
                <strong>"Service"</strong> refers to Bwain.app, including the
                website, PWA, and backend API
              </li>
              <li>
                <strong>"User," "you,"</strong> or <strong>"your"</strong>{" "}
                refers to the person accessing or using the Service
              </li>
              <li>
                <strong>"We," "us,"</strong> or <strong>"our"</strong> refers to
                Bwain.app and its operators
              </li>
              <li>
                <strong>"Content"</strong> refers to tasks, lists, notes,
                reminders, budget data, and schedule events created by users
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              ...
              By signing in, you authorize us to access certain information from
              your Google account as described in our Privacy Policy.
            </p>
            ...
            <p className="text-foreground leading-relaxed">
              ...
              and to keep your Google account information up to date.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              ...
              the Service (tasks, lists, notes, etc.). We do not claim ownership
              of your Content.
            </p>
            ...
            <p className="text-foreground leading-relaxed">
              By creating Content, you grant us a limited, non-exclusive,
              worldwide license to store, process, and display your Content
            ...
            <p className="text-foreground leading-relaxed">
              ...
              monitor, or endorse Content created by users.
            </p>
            ...
            <p className="text-foreground leading-relaxed">
              ...
              maintaining your own backups of important Content. We recommend
              exporting your data regularly (feature available in V1.1).
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              ...
              We may also perform scheduled maintenance that temporarily
              interrupts access.
            </p>
            ...
            <p className="text-foreground leading-relaxed">
              ...
              Service downtime, modifications, or discontinuation.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              Bwain.app is currently provided free of charge. We reserve the
              right to introduce paid features or subscriptions in the future.
              If we do so, we will provide advance notice and update these Terms
              accordingly.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              The Service, including its design, code, graphics, logos, and
              trademarks, is owned by Bwain.app and protected by copyright,
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              ...
              Service at any time, with or without cause or notice, including if
            ...
            <p className="text-foreground leading-relaxed">
              ...
              cease. We may delete your Content after a reasonable period,
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed uppercase font-semibold">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, BWAIN.APP SHALL NOT BE
            ...
            <p className="text-foreground leading-relaxed mt-4">
              ...
              AMOUNT YOU PAID US IN THE PAST 12 MONTHS, WHICHEVER IS LESS.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              You agree to indemnify, defend, and hold harmless Bwain.app and
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              ...
              seek injunctive relief in court for violations of intellectual
              property rights.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              ...
              entire agreement between you and Bwain.app regarding the Service.
            </p>
          ...
          <section className="bg-dusk-50 dark:bg-dusk-950 p-6 rounded-lg border-2 border-dusk-200 dark:border-dusk-800">
            ...
            <p className="text-foreground leading-relaxed">
              BY USING BWAIN.APP, YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS
              OF SERVICE AND AGREE TO BE BOUND BY THEM. IF YOU DO NOT AGREE TO
