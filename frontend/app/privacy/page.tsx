        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              Welcome to Bwain.app ("we," "our," or "us"). We are committed to
              protecting your privacy and ensuring the security of your personal
              information. This Privacy Policy explains how we collect, use,
              store, and protect your data when you use our Progressive Web
              Application (PWA) and related services.
            </p>
            <p className="text-foreground leading-relaxed mt-4">
              By using Bwain.app, you agree to the collection and use of
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-foreground space-y-2 mt-2">
              <li>
                <strong>Tasks:</strong> Task descriptions, due dates, completion
                status
              </li>
              <li>
              ...
              <li>
                <strong>Reminders:</strong> Reminder messages, times, and
                recurrence settings
              </li>
              <li>
                <strong>Budget Data:</strong> Transaction amounts, categories,
                and descriptions
              </li>
              <li>
                <strong>Schedule Events:</strong> Event titles, dates, times,
                and descriptions
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 text-foreground space-y-2 mt-2">
              ...
              <li>
                ...
                (stored temporarily for debugging)
              </li>
            </ul>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-foreground space-y-2 mt-2">
              ...
              <li>
                <strong>Service Delivery:</strong> To provide productivity
                features (tasks, lists, notes, etc.)
              </li>
              <li>
                <strong>Data Synchronization:</strong> To sync your data across
                devices
              </li>
              <li>
                <strong>Reminders:</strong> To send notifications at scheduled
                times (with your permission)
              </li>
              <li>
              ...
              <li>
                <strong>Technical Support:</strong> To diagnose and fix
                technical issues
              </li>
              <li>
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              Bwain.app uses Google OAuth 2.0 for authentication and may request
              access to additional Google APIs in the future. Our use and
            ...
            <ul className="list-disc pl-6 text-foreground space-y-2 mt-2">
              <li>
                <strong>Google Sign-In:</strong> OAuth 2.0 authentication
            ...
            <ul className="list-disc pl-6 text-foreground space-y-2 mt-2">
              <li>
                <strong>Google Calendar:</strong> To sync your schedule with
                your Google Calendar
              </li>
              <li>
                <strong>Google Drive:</strong> To attach files to tasks and
                notes
              </li>
              <li>
              ...
              <li>
                <strong>Google Tasks:</strong> To sync tasks between Bwain.app
                and Google Tasks
              </li>
              <li>
                <strong>Google Contacts:</strong> To share tasks with your
                contacts
              </li>
            </ul>
            <p className="text-foreground leading-relaxed mt-4">
              <strong>Important:</strong> You will be asked for explicit
              permission before we access any additional Google services. You
              can revoke these permissions at any time through your Google
              Account settings.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-foreground space-y-2 mt-2">
              <li>
                <strong>Backend Database:</strong> Your productivity data is
                stored in a secure SQLite database hosted on Fly.io servers
                (United States)
              </li>
              <li>
                <strong>Browser Storage:</strong> Session tokens are stored in
                secure httpOnly cookies
              </li>
              <li>
                <strong>Service Worker Cache:</strong> Static assets are cached
                locally for offline functionality (no personal data)
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 text-foreground space-y-2 mt-2">
              ...
              <li>
                <strong>OAuth 2.0:</strong> Industry-standard authentication
                protocol
              </li>
              <li>
                <strong>Token-Based Authentication:</strong> Short-lived access
                tokens with automatic refresh
              </li>
              <li>
                <strong>Database Isolation:</strong> All user data is isolated
                by Google User ID
              </li>
              <li>
              ...
              <li>
                <strong>No Password Storage:</strong> We never store passwords
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-foreground space-y-2 mt-2">
              <li>
                <strong>Service Providers:</strong> We use Fly.io for backend
                hosting and Vercel for frontend hosting. These providers have
                access to data only to perform tasks on our behalf and are
                obligated to protect it.
              </li>
              <li>
                <strong>Google:</strong> Your Google OAuth tokens are shared
                with Google only for authentication purposes.
              </li>
              <li>
              ...
              <li>
                <strong>Security:</strong> We may disclose information to
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              You can access all your data directly through the Bwain.app
              interface. You can export your data at any time (feature coming in
              V1.1).
            </p>
            ...
            <p className="text-foreground leading-relaxed">
              You can edit or delete any of your productivity data (tasks,
              lists, notes, etc.) directly in the app. To delete your entire
              account, contact us at privacy@bwain.app.
            </p>
            ...
            <p className="text-foreground leading-relaxed">
              You can revoke Bwain.app's access to your Google account at any
            ...
            <p className="text-foreground leading-relaxed">
              ...
              settings, but this will log you out and may affect functionality.
            </p>
            ...
            <p className="text-foreground leading-relaxed">
              You can enable or disable push notifications through your device
              settings or browser permissions.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              Bwain.app is not intended for children under the age of 13. We do
              not knowingly collect personal information from children under 13.
              If you are a parent or guardian and believe your child has
              provided us with personal information, please contact us at
              privacy@bwain.app, and we will delete such information from our
              systems.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              Bwain.app is operated from the United States. If you are accessing
              ...
              the United States. By using our services, you consent to this
              transfer.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              ...
              the following additional rights under the General Data Protection
              Regulation (GDPR):
            </p>
            <ul className="list-disc pl-6 text-foreground space-y-2 mt-2">
              <li>
            ...
            <p className="text-foreground leading-relaxed mt-4">
              To exercise these rights, contact us at privacy@bwain.app. We will
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-foreground space-y-2 mt-2">
              ...
              <li>
                ...
                personal information (note: we do not sell your data)
              </li>
              <li>
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed mt-4">
              Your continued use of Bwain.app after any changes indicates your
          ...
          <section className="bg-twilight-50 dark:bg-twilight-950 p-6 rounded-lg border-2 border-twilight-200 dark:border-twilight-800">
            ...
            <p className="text-foreground leading-relaxed">
              By using Bwain.app, you acknowledge that you have read and
