...
export const noteFixtures = {
    meeting: {
        ...
        content: 'Discussed project timeline, assigned roles, and set next milestones. Next meeting scheduled for Friday.',
    ...
    idea: {
        ...
        content: 'Implement AI-powered automatic categorization for budget entries based on description patterns.',
    ...
    reference: {
        ...
        content: 'Discord.js: https://discord.js.org/\nSequelize: https://sequelize.org/\nJest: https://jestjs.io/',
...
export const DatabaseFixtureFactory = {
     ...
     */
    createUserDataSet(userId: string = testUsers.standard.id, guildId: string = testGuilds.standard.id) {
        return {
            tasks: [
            ...
            budgetEntries: [
                this.createBudgetEntry({ userId, guildId, description: 'Coffee', amount: 5.50 }),
                this.createBudgetEntry({ userId, guildId, description: 'Lunch', amount: 12.00 }),
                this.createBudgetEntry({ userId, guildId, description: 'Income', amount: 100.00, type: 'income' })
            ],
            schedules: [
