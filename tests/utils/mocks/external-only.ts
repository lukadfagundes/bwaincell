...
export const mockDiscordJs = () => {
    return jest.mock('discord.js', () => {
        ...
        return {
            ...
            Routes: {
                applicationCommands: jest.fn((applicationId: string) => `/applications/${applicationId}/commands`),
                applicationGuildCommands: jest.fn((applicationId: string, guildId: string) =>
