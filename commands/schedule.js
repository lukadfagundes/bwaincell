        ...
        try {
            switch (subcommand) {
                case 'add': {
                    ...
                    const scheduled = await Schedule.addEvent(userId, guildId, event, dateStr, timeStr, description);
                ...
                case 'list': {
                    ...
                    const events = await Schedule.getEvents(userId, guildId, filter);
                ...
                case 'delete': {
                    ...
                    const deleted = await Schedule.deleteEvent(eventId, userId, guildId);
                ...
                case 'countdown': {
                    ...
                    const result = await Schedule.getCountdown(userId, guildId, eventName);
                ...
                case 'today': {
                    const events = await Schedule.getTodaysEvents(userId, guildId);
                ...
                case 'week': {
                    const events = await Schedule.getUpcomingEvents(userId, guildId, 7);
            ...
            console.error(`Error in schedule ${subcommand}:`, error);
            const errorMessage = {
